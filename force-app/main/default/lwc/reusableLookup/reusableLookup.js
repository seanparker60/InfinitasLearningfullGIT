...
import fetchRecords from '@salesforce/apex/UTIL_ReusableLookupController.fetchRecords';
...
export default class ReusableLookup extends LightningElement {
    ...
    @api booleanSearchField;
    @api booleanSearchValue;
    ...
    get methodInput() {
        return {
            ...
            booleanSearchField: this.booleanSearchField,
            booleanSearchValue: this.booleanSearchValue
        };
    }
